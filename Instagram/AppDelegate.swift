...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let ParseConfig = ParseClientConfiguration { (ParseMutableClientConfiguration) in
            ...
            ParseMutableClientConfiguration.clientKey = "0c55a9443f592a5705d44e4a01e0d98ee04baeb0"
            ParseMutableClientConfiguration.server = "http://ec2-35-167-70-149.us-west-2.compute.amazonaws.com:80/parse"
        }
        login()
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "Instagram2_0")
